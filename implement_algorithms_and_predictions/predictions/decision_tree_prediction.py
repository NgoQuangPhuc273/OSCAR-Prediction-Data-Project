...
def decision_tree():
    ...
    for single_year in years:
        ...
        predicted_result.to_csv("final_prediction_csv/decision_tree/predict_result_{}.csv".format(str(single_year)))
        
        predicted_result.plot(kind='barh',x='Movie',y='Predicted Win Rate',color='crimson',figsize=(10, 5)) 
        ...
        plt.tight_layout()
        plt.savefig('final_predictions_graphs/predictions/{}/{}_decision_tree.png'.format(str(single_year),str(single_year)))
