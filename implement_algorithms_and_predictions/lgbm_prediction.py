...
def lgbm():
    ...
    fig = px.bar(LGBM_importances, x='Features', y='Importances Weightage', 
                title='Light Gradient Boosting Machine Features Importances', height=600)
    fig.show()
    ...
    predict_result_2015.to_csv("final_prediction/lgbm/predict_result_2015.csv")
    ...
    predict_result_2016.to_csv("final_prediction/lgbm/predict_result_2016.csv")
    ...
    predict_result_2017.to_csv("final_prediction/lgbm/predict_result_2017.csv")
    ...
    predict_result_2018.to_csv("final_prediction/lgbm/predict_result_2018.csv")
    ...
    predict_result_2019.to_csv("final_prediction/lgbm/predict_result_2019.csv")